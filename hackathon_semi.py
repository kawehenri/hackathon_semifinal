...
'''
1. Falta de dois pontos (def mostrar_menu() )
2. Erro de mensagem onde deveria ser "Usuario adicionado com sucesso" está "Usuario não adicionado com sucesso"
3. Falta de contenação
4. Erros de escrita
'''